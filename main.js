...
const animeData= [
    ...
    //21
    {
        id: 20,
        title: "Mieruko-chan",
        description: "Повседневная жизнь старшеклассницы Мико резко меняется, когда она пробуждает в себе шестое чувство и начинает видеть души умерших и призраков. Она не может перестать видеть ужасных, отвратительных монстров и не знает причины проявления этих способностей. Несмотря на то, что Мико очень напугана, она продолжает свою повседневную жизнь как ни в чем не бывало и делает вид, что не замечает кошмара, который ее окружает. Не сойти с ума девушке помогает ее лучшая подруга Хана. С этого момента Мико придется пройти через множество трудностей и узнать подробности таинственных явлений, происходящих с ней.",
        ...
        link: "https://www.youtube.com/embed/tzE5PxP34mk",
    },
    //22
    {
        id: 21,
        title: "Rascal Does Not Dream of Bunny Girl Senpai",
        description: "Сакура Азусагава, сидя в обычной городской библиотеке, сталкивается с невероятно таинственным и в то же время безумно привлекательным незнакомцем. Она одета в откровенный костюм кролика, который полностью противоречит окружающей обстановке. Они определенно еще не появлялись в таких нарядах в читальном зале. Странный человек появляется как Сакурадзиме Май. Ее совершенно не волнует, что думает толпа и какие вообще существуют библиотечные правила. У девушки есть вопрос гораздо более важный, чем осуждение и ворчание местного сотрудника.",
        ...
        link: "https://www.youtube.com/embed/o0TZj_d3Yfg",
    },
    //23
    {
        id: 22,
        title: "Your Lie in April",
        description: "Косей Арима - пианист-виртуоз, как говорили его наставники. С юных лет он играл самые сложные композиции благодаря своему чутью, он делал все точно так, как предписано в нотах, даже механически. Выиграв множество соревнований, специалисты все равно говорили, что дело было не в таланте, а в дисциплине и упорстве, и мальчик просто быстро справлялся с нагрузками. Как бы то ни было, он был признан одним из лучших пианистов в своей категории. Когда ему исполнилось 11 лет, умерла его мать, которая была главным наставником. После этой трагедии мальчик больше не подходил к пианино, он перестал чувствовать музыку, которую играл. Он запирается в своем мире, где есть место только для двух старых друзей - Цубаки и Реты.",
        ...
        link: "https://www.youtube.com/embed/aMJpI_fEsA4",
    },
    //24
    {
        id: 23,
        title: "Noragami",
        description: "Как странствующий японский бог, который недавно потерял абсолютно все. Главный герой спустился на землю и пытается сделать все возможное, чтобы выжить. Оказывается, каждому божественному созданию нужны люди, которые в него верят. Это добавляет невероятного количества сил, но для этого все слишком печально. У него нет поклонников, и вдобавок его бросает Майя, которая является его оружием. Вы должны прятаться от демонов, пытающихся убить любого, кто встанет у них на пути.",
        ...
        link: "https://www.youtube.com/embed/IQnnwUXd_0U",
    },
    //25
    {
        id: 24,
        title: "Cyberpunk: Edgerunners",
        description: "Night City - это город будущего, оснащенный всеми видами новейших технологий. Город, где модификация тела - это не просто мечты безумных ученых, а реальность, сродни обычной покупке. Именно там живет наш юный герой, для которого этот город не является чем-то невообразимым, он знает всю его настоящую суть, где выживание - это не просто слово, а истинное лицо этого мира. В одно мгновение потеряв все, что у него было, парень не сдается и в борьбе за выживание становится наемником по прозвищу Киберпанк.",
